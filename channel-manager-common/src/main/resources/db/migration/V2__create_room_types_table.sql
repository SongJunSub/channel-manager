...
CREATE TABLE room_types (
    ...
    room_type_code VARCHAR(20)    NOT NULL,                   -- 객실 타입 고유 코드 (STD, DLX, STE 등)
    room_type_name VARCHAR(50)    NOT NULL,                   -- 객실 타입명
    max_capacity   INT            NOT NULL DEFAULT 2,         -- 최대 수용 인원 (기본 2명)
