...
class RateLimitFilter : WebFilter {
    ...
    companion object {
        ...
        // Rate Limiting 설정값
        private const val CAPACITY = 50L        // 버킷 최대 용량 (초당 최대 50건 버스트)
        private const val REFILL_TOKENS = 50L   // 충전할 토큰 수
        private val REFILL_DURATION: Duration = Duration.ofSeconds(1) // 충전 주기 (1초)
    }
